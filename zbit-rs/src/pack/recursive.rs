...
// IMMED-1.2 migration target (future ZBPK bump): the section below currently rolls its own
...
// Blocked by: a ZBPK_VERSION bump after v4, updating decode_recursive_circuit_payload to
